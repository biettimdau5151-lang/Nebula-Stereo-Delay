...
//! ```text
//! ┌──────────────────────────────────────────────────────────────────┐
//! │ Top Bar: Name v1.2 | Preset | A/B | ← → | FX ON | FREE | UNLINKED │
//! ├───────────────────────┬────────┬───────────────────────────────┤
...
const BG: Color32 = Color32::from_rgb(0x1C, 0x1C, 0x1C);
/// Panel / section background — medium gray.
const PANEL_BG: Color32 = Color32::from_rgb(0x2A, 0x2A, 0x2A);
/// Inset / recessed area background.
const INSET_BG: Color32 = Color32::from_rgb(0x16, 0x16, 0x16);
/// Widget surface (knob body, button face).
const WIDGET_BG: Color32 = Color32::from_rgb(0x3E, 0x3E, 0x3E);
/// Accent colour — yellow / gold.
const ACCENT: Color32 = Color32::from_rgb(0xFF, 0xBE, 0x00);
/// Accent at reduced opacity for highlight backgrounds.
const ACCENT_DIM: Color32 = Color32::from_rgba_premultiplied(0xFF, 0xBE, 0x00, 0x44);
const MAGENTA: Color32 = Color32::from_rgb(0xFF, 0x28, 0xC7);
const ORANGE: Color32 = Color32::from_rgb(0xFF, 0xA8, 0x00);
const PURPLE: Color32 = Color32::from_rgb(0x4A, 0x9E, 0xFF);
const METER_GREEN: Color32 = Color32::from_rgb(0x4C, 0xFF, 0x74);
/// Primary text — white.
const TEXT_PRI: Color32 = Color32::from_rgb(0xFF, 0xFF, 0xFF);
/// Secondary / label text — light gray.
const TEXT_SEC: Color32 = Color32::from_rgb(0xC8, 0xC8, 0xC8);
/// Knob track (unfilled arc).
const KNOB_TRACK: Color32 = Color32::from_rgb(0x32, 0x32, 0x32);
/// Active / "on" button fill.
const BTN_ON: Color32 = ACCENT;
/// Inactive / "off" button fill.
const BTN_OFF: Color32 = Color32::from_rgb(0x2A, 0x2A, 0x2A);
/// Bypass / danger indicator.
const DANGER: Color32 = Color32::from_rgb(0xCC, 0x33, 0x33);
/// Border / separator.
const BORDER: Color32 = Color32::from_rgb(0x5A, 0x5A, 0x5A);
    ...
    Frame::NONE
        ...
        .show(ui, |ui| {
            ...
            ui.horizontal_wrapped(|ui| {
                ...
                ui.label(rich("v1.2", 9.0 * s).color(TEXT_SEC));
                ui.add_space(14.0 * s);
