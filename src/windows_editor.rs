...
impl Colors {
    const BG: D2D1_COLOR_F = color(28, 28, 28, 255);
    const TOP: D2D1_COLOR_F = color(36, 36, 36, 255);
    const PANEL: D2D1_COLOR_F = color(42, 42, 42, 255);
    const CARD: D2D1_COLOR_F = color(52, 52, 52, 255);
    const CONTROL: D2D1_COLOR_F = color(62, 62, 62, 255);
    const BORDER: D2D1_COLOR_F = color(90, 90, 90, 255);
    const DIVIDER: D2D1_COLOR_F = color(50, 50, 50, 255);
    const ACCENT: D2D1_COLOR_F = color(255, 190, 0, 255);
    const ACCENT_DARK: D2D1_COLOR_F = color(200, 150, 0, 255);
    const ACCENT_LIGHT: D2D1_COLOR_F = color(255, 230, 100, 255);
    const ACCENT_SOFT: D2D1_COLOR_F = color(255, 190, 0, 42);
    const ORANGE: D2D1_COLOR_F = color(255, 170, 0, 255);
    const MAGENTA: D2D1_COLOR_F = color(255, 32, 200, 255);
    const PURPLE: D2D1_COLOR_F = color(74, 158, 255, 255);
    const GREEN: D2D1_COLOR_F = color(75, 255, 116, 255);
    const TEXT_LIGHT: D2D1_COLOR_F = color(255, 255, 255, 255);
    const TEXT_PRIMARY: D2D1_COLOR_F = color(255, 255, 255, 255);
    const TEXT_SECONDARY: D2D1_COLOR_F = color(200, 200, 200, 255);
}
